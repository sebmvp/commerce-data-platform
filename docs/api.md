...
View-backed routes are a thin resale read model. `/business/*`, `/context`, `/answer`, and `/ingest/trust` call domain services / the Librarian. They do not reimplement business rules.
